<?php 
	...
	$sql = "SELECT mhs.nim, mhs.nama, matkul.idmk, matkul.namamk, presensi.tgl, presensi.status FROM(presensi LEFT JOIN mhs on mhs.nim = presensi.nim) LEFT JOIN matkul on matkul.idmk = presensi.idmk WHERE matkul.namamk = '".$q."'";
